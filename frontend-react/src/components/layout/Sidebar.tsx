...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, userRole }) => {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 bg-card border-r border-border z-50 transform transition-transform duration-300 ease-in-out md:relative md:transform-none md:top-0 md:h-full md:block",
