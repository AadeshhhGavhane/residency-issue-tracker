    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="shadow-card">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-yellow-600">{monthlyData.averageRating.toFixed(1)}</div>
            <p className="text-xs text-muted-foreground">
              {Math.round(monthlyData.resolutionTime / (1000 * 60 * 60 * 24))} days avg resolution
            </p>
          </CardContent>
        </Card>
      </div>
